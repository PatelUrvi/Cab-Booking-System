<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_master_page.master" AutoEventWireup="true" CodeFile="add_outstation_cab_rate.aspx.cs" Inherits="add_outstation_cab_rate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>Add Outstation Cab Rates</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" 
            Text="Add Outstation Cab Rates"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;<br />
    <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <asp:DropDownList ID="cmb_type" runat="server" Height="24px" 
        Width="167px">
...
<asp:Button 
            ...
            Text="ADD TYPE" Width="96px" BackColor="#CCCCCC" 
...
<input id="Reset1" 
    ...
    <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="X-Large" 
            Text="Already Added Outstation Cab Rates"></asp:Label>
        <br />
    <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
        CellPadding="3" DataKeyNames="outstation_cab_id" DataSourceID="SqlDataSource1" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM [tbl_outstation_cab_rate] WHERE [outstation_cab_id] = @outstation_cab_id" 
        InsertCommand="INSERT INTO [tbl_outstation_cab_rate] ([cab_type], [minimum_bill_charge], [free_kms], [waiting_charge], [extra_per_km_charge], [kms]) VALUES (@cab_type, @minimum_bill_charge, @free_kms, @waiting_charge, @extra_per_km_charge, @kms)" 
        SelectCommand="SELECT * FROM [tbl_outstation_cab_rate]" 
        UpdateCommand="UPDATE [tbl_outstation_cab_rate] SET [cab_type] = @cab_type, [minimum_bill_charge] = @minimum_bill_charge, [free_kms] = @free_kms, [waiting_charge] = @waiting_charge, [extra_per_km_charge] = @extra_per_km_charge, [kms] = @kms WHERE [outstation_cab_id] = @outstation_cab_id">
        <DeleteParameters>
            <asp:Parameter Name="outstation_cab_id" Type="Int32" />
        </DeleteParameters>
        <InsertParameters>
