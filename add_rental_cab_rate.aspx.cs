...
public partial class add_rental_cab_rate : System.Web.UI.Page
{
    ...
    public void insertdata()
    {
        ...
        cmd.Parameters.Add(new SqlParameter("@mode", SqlDbType.VarChar)).Value = "Rental Cab";
        ...
        if (k != 0)
        {
            Response.Redirect("add_rental_cab_rate.aspx");
        }
    }
